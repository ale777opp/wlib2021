...
template: '<div v-for = "item in option"><a href="#">{{item}}</a></div>'
})

/*
<span>{{option.subMenu}}</span>

<div v-for = "(it, ind) in option.subMenu" :class = "subMenuClass(ind)"><a :href="`${option.hrefItem[ind]}`">{{it}}</a></div></template>
*/
