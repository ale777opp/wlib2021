...
<div id="infor">
<div class="col_title"><span id="index_" class="bread" onmousedown="goToLocation(this.id)">Главная</span> / <span class="bread" onmousedown="goToLocation('regform')">Регистрация</span> / <span class="caption">Регистрация индивидуальных пользователей</span></div>
<div>
