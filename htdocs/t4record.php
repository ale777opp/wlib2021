...
<link rel="shortcut icon" href="//opac64-test.liart.local/test4/favicon.ico" type="image/x-icon"/>
...
define('THEHISTORYPATH', 'C:/opac-global/web/test4/htdocs/test4/_test4');
define('THEHTMLPATH', 'test4/test4/_test4');
define('THEIMGPATH', '/test4/test4/img');
define('THEFULLJSPATH', 'C:/opac-global/web/test4/htdocs/test4/js');
define('THEJSPATH', '/test4/test4/js');
define('THEFULLCSSPATH', 'C:/opac-global/web/test4/htdocs/test4/css');
define('THECSSPATH', '/test4/test4/css');
define('THEPAGESPATH', 'test4/html/pages');
define('THEMODULESPATH', 'test4/html/_modules');
define('THEINCLUDESPATH', 'test4/html/_includes');
define('THEFOLDERNAME', 'test4');
define('THEPATHACTRCP', '/t4request');
define('THEPATHFIND', '/t4find');
define('THEPATHREG', '/t4reg');
define('THEPAGESEARCHPATH', 't4record');
...
define('THEOGURL', '//opac64-test.liart.local/test4');
define('THEOGIMAGE', '//opac64-test.liart.local/test4/test4/img/logo_big.jpg');
